...
#ifndef INTERSECTOR_SWIFT_H
#define INTERSECTOR_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Intersector",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11Intersector16LocationProvider")
...
@class CLLocation;
@class CLHeading;
@interface LocationProvider (SWIFT_EXTENSION(Intersector)) <CLLocationManagerDelegate>
