...
#ifndef INTERSECTOR_WATCH_APP_SWIFT_H
#define INTERSECTOR_WATCH_APP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Intersector_Watch_App",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class CLLocation;
@class CLHeading;
SWIFT_CLASS("_TtC21Intersector_Watch_App21WatchLocationProvider")
@interface WatchLocationProvider : NSObject <CLLocationManagerDelegate>
